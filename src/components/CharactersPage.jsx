...
const CharactersPage = () => {
    ...
    const characters = [
        {
            name: "BUD-Your Personal Companion",
            description:
                                ...
                                <CardBody className="relative h-[500px] w-full max-w-[350px] rounded-2xl bg-white/50 dark:bg-gray-800/50 p-6 shadow-lg hover:shadow-xl transition-transform transform hover:scale-105">
                                    ...
                                    <div className="flex justify-between items-center mt-6">
                                        <CardItem translateZ="40">
                                            <a href="#" className="text-green-600 hover:text-green-700 dark:hover:text-green-400">
                                                Know More →
                                            </a>
                                        </CardItem>
                                        ...
                                        <CardItem translateZ="40">
                                            <button
                                                onClick={() => navigate(`/chat/${character.name.toLowerCase()}`)}
